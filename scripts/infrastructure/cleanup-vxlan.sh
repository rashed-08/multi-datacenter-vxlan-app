...
sudo ip link set vxlan${VXLAN_DC1_ID} nomaster || true
...
sudo ip link delete br-dc1  || true
...
sudo ip link delete br-dc2 || true

# DC3
echo "Removing vxlan${VXLAN_DC3_ID}..."
sudo ip link set vxlan${VXLAN_DC3_ID} nomaster || true
...
sudo ip link delete br-dc3 || true
